...
class VarNet(nn.Module):
    ...
    def __init__(
        ...
        n_feat0: int = 48, #48
        feature_dim: List[int] = [6, 12, 18],
        #feature_dim: List[int] = [72, 96, 120],
        prompt_dim: List[int] = [6, 12, 18],
        #prompt_dim: List[int] = [24, 48, 72],
        sens_n_feat0: int =24,
        sens_feature_dim: List[int] = [6, 12, 18],
        #sens_feature_dim: List[int] = [36, 48, 60],
        sens_prompt_dim: List[int] = [6, 12, 18],
        len_prompt: List[int] = [4, 4, 4],
        #len_prompt: List[int] = [5, 5, 5],
        prompt_size: List[int] = [32, 16, 8],
        #prompt_size: List[int] = [64, 32, 16],
        n_enc_cab: List[int] = [1, 1, 1],
        #n_enc_cab: List[int] = [2, 3, 3],
        n_dec_cab: List[int] = [1, 1, 1],
        #n_dec_cab: List[int] = [2, 2, 3],
        n_skip_cab: List[int] = [1, 1, 1],
        n_bottleneck_cab: int = 3,
        no_use_ca: bool = False,
